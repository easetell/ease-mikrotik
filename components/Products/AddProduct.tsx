...
const AddProduct: React.FC<AddProductProps> = ({ onClose, isVisible }) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (!isAdmin) {
            toast.error('Sorry you do not have permission to add product.');
            return;
        }

        const price = parseFloat(inputValue.replace(/,/g, ''));
