...
import AddPPPoEPlan from "./AddPPPoEPlan";
...
const PPPoEPlanHeader: React.FC<PPPoEHeaderProps> = ({
  searchTerm,
  onSearchChange,
}) => {
  ...
  return (
    <>
      <div className="block items-center justify-between sm:flex">
        ...
        <AddPPPoEPlan isVisible={isAddFormVisible} onClose={closeAddForm} />
      </div>
    </>
  );
};

export default PPPoEPlanHeader;
