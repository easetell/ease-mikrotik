...
const DeletePPPoE: React.FC<DeletePPPoEProps> = ({
  onClose,
  isVisible,
  selectedIdNo,
}) => {
  const deletePPPoE = async () => {
    try {
      ...
      toast.error("An error occurred while deleting the PPPoE");
    }
  };
    ...
    <>
      ...
      >
        ...
        <h3 className="mb-6 text-lg text-gray-500 dark:text-gray-400">
          Are you sure you want to delete this PPPoE Client?
        </h3>
        <button
          onClick={deletePPPoE}
